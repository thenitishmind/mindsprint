          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div className="hidden md:block md:w-1/2 lg:w-2/5 max-w-md">
              <div className="text-center md:text-left mb-8">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Welcome to MindSprint</h1>
                <p className="text-lg text-gray-600">
                  Your one-stop platform for learning, practice, and growth in tech skills.
                </p>
              </div>
